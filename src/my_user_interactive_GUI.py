...
class FileWidget(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("Multiple Tags creator")
        ...
        self.submit_button = QPushButton("Create Tags", self)
        ...
        self.textbox.setToolTip(
            "Use-<br><b>\\n</b> for new line<br><b>\\t</b> for tab space<br><i>NOTE: If you are using </i><b>\\t</b><i> then make sure to add </i><b>\\t</b><i> everywhere even when you are switching to new line in the file for importing tags!</i>")
